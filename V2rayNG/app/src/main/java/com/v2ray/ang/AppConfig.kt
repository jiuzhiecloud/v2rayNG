...
object AppConfig {
    ...
    const val ANDROID_PACKAGE_NAME_LIST_URL = "$GITHUB_RAW_URL/jiuzhiecloud/free-sub/refs/heads/main/README.md"
    const val APP_URL = "$GITHUB_URL/jiuzhiecloud/free-sub"
    const val APP_API_URL = "https://api.github.com/repos/jiuzhiecloud/free-sub/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/2dust/v2rayNG/master/CR.md"
    const val APP_PROMOTION_URL = "aHR0cHM6Ly9qaXV6aGllY2xvdWQuZ2l0aHViLmlvL2ZyZWUtc3ViLw=="
    const val TG_CHANNEL_URL = "https://t.me/jiuzhiecloud"
